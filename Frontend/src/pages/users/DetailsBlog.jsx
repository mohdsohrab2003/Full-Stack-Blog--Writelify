...
//       const filterBlogs = useSelector((state) => state.blog.filterBlogs);
//       const blogData = filterBlogs.find((blog) => blog._id.toString() === id);
//       setData(blogData);
...
const DetailsBlog = () => {
    ...
    try {
      ...
      if (!blogData) {
        ...
        if (blogData.description) {
          ...
          setEstimatedReadTime(Math.max(1, Math.ceil(wordCount / 200)));
        }
  ...
  const toggleBookmark = useCallback(() => {
    ...
    try {
      ...
      console.warn("Could not save bookmark state:", error);
    }
  }, [isBookmarked, id]);
  ...
  const toggleLike = useCallback(() => {
    ...
    try {
      ...
      console.warn("Could not save like state:", error);
    }
  }, [isLiked, id]);

  const handleImageError = (e) => {
    e.target.src =
      "/placeholder.svg?height=600&width=1200&text=Image+Not+Found";
  };
        ...
        <div className="text-center max-w-md mx-auto px-4">
          <div className="mb-6">
            <div className="w-16 h-16 mx-auto bg-gray-200 rounded-full flex items-center justify-center mb-4">
              <FaArrowLeft className="w-6 h-6 text-gray-400" />
            </div>
          </div>
          <h2 className="text-2xl font-bold text-gray-800 mb-4">
          ...
          <p className="text-gray-600 mb-6">
            {error === "Blog post not found"
              ...
              : "We encountered an error while loading the blog post. Please try again."}
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <button
              onClick={() => navigate("/")}
              className="px-6 py-3 bg-[#5044E5] text-white rounded-lg hover:bg-[#4035c5] transition-colors duration-300 font-medium"
            >
              Go to Homepage
            </button>
          </div>
    ...
    <>
      ...
      <div className="relative min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 text-gray-600 hover:text-[#5044E5] transition-colors duration-300 group focus:outline-none focus:ring-2 focus:ring-[#5044E5] focus:ring-offset-2 rounded-lg px-2 py-1"
        ...
        <article className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <header className="text-center space-y-6 sm:space-y-8 mb-12 sm:mb-16">
            ...
            <div className="flex items-center justify-center gap-4 pt-6">
              <button
                onClick={toggleLike}
                className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                  isLiked
                    ? "bg-red-500 text-white focus:ring-red-500 shadow-lg"
                    : "bg-gray-100 text-gray-600 hover:bg-red-50 hover:text-red-500 focus:ring-red-500"
                }`}
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-full transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                  isBookmarked
                    ? "bg-[#5044E5] text-white focus:ring-[#5044E5] shadow-lg"
                    : "bg-gray-100 text-gray-600 hover:bg-[#5044E5]/10 hover:text-[#5044E5] focus:ring-[#5044E5]"
                }`}
                aria-label={
              ...
              <div className="relative share-menu-container">
                <button
                  onClick={() => setShowShareMenu(!showShareMenu)}
                  className="flex items-center gap-2 px-4 py-2 bg-gray-100 text-gray-600 rounded-full hover:bg-gray-200 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
                ...
                {showShareMenu && (
                  <div className="absolute top-full mt-2 right-0 bg-white rounded-xl shadow-lg border border-gray-100 p-2 min-w-[200px] z-20">
                    <button
                      onClick={() => handleShare("facebook")}
                      className="w-full flex items-center gap-3 px-4 py-2 text-left hover:bg-gray-50 rounded-lg transition-colors duration-200 focus:outline-none focus:bg-gray-50"
                    >
                      <FaFacebookF className="text-blue-600" />
                      <span>Facebook</span>
                    </button>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                <img
                  ...
                  onError={(e) => {
                    e.target.src =
                      "/placeholder.svg?height=56&width=56&text=Author";
                  }}
                />
                <div>
                  <h3 className="font-semibold text-gray-800">Michael Brown</h3>
              ...
              <div className="flex items-center gap-4">
                <button
                  onClick={toggleLike}
                  className={`flex items-center gap-2 px-6 py-3 rounded-full font-medium transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                    isLiked
